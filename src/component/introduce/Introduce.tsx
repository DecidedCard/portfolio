...
export default function Introduce() {
  ...
  return (
    ...
    >
      <motion.h1 className="text-green pb-8 text-2xl" variants={FadeUp}>
        안녕하세요. 저는 웹 개발자
      </motion.h1>
      <motion.h2
        className="text-lightest-slate pb-6 text-6xl font-bold"
        variants={FadeUp}
      >
        유승윤입니다.
      </motion.h2>
      ...
      <motion.p
        className="max-w-[580px] pb-8 text-xl break-keep"
        variants={FadeUp}
      >
      ...
      <motion.ol className="text-green flex gap-4" variants={FadeUp}>
        {ICONLIST.map((obj, i) => (
